<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Continental.aspx.cs" Inherits="dbfinalproject_phase2.Continental" %>
...
<body>    
    ...
    <asp:Image ID="Image1" ImageUrl="https://arcadiancafe.com/wp-content/uploads/2021/06/HoisinChiliWings.jpg" width = "523px" Height ="350px" runat="server" style="margin-left: 66px; margin-right: 1031px; margin-top: 32px; margin-bottom: 25px;" />          
                ...
                <br/> <br/>
                <div>
                   <asp:Image ID="Image4"  ImageUrl="https://arcadiancafe.com/wp-content/uploads/2021/04/EuroFiesta.jpg" height="320px" width="490px"  runat="server" style="margin-left: 66px; margin-bottom: 55px; margin-right: 66px; margin-top: 0px;" />
                     <div class = "top-right">
                    <h1> Hoisin Chilli Wings</h1>
                    <h2>Rs.  1500</h2>
    ...
    <br/> <br/>
                ...
                <div style="height: 387px">
                    <asp:Image ID="Image2"  ImageUrl="https://arcadiancafe.com/wp-content/uploads/2021/08/nashvilledynamiteburger.jpg" height="402px" width="501px"  runat="server" style="margin-left: 65px; margin-bottom: 0px; margin-right: 2px; margin-top: 0px;" />
                      <div class = "top-right1">
                    <h1> Euro Fiesta</h1>
                    <h2 style="height: 34px; width: 374px">Rs.  1500</h2>
    ...
    <br/> <br/>      
     ...
     <div>
         <asp:Image ID="Image3" ImageUrl="https://arcadiancafe.com/wp-content/uploads/2021/08/rattlesnakepasta.jpg" width = "463px" Height ="347px" runat="server" style="margin-right: 38px; margin-top: 63px; margin-left: 68px; margin-bottom: 3px;" />
     <div class = "top-right2">
                    <h1> Dynamite Burger</h1>
                    <h2>Rs.  1000</h2>
