<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Desserts.aspx.cs" Inherits="dbfinalproject_phase2.Desserts" %>
...
<body>    
    ...
    <asp:Image ID="Image1" ImageUrl="https://arcadiancafe.com/wp-content/uploads/2021/05/CookiSkillet.jpg" width = "523px" Height ="350px" runat="server" style="margin-left: 66px; margin-right: 1031px; margin-top: 32px; margin-bottom: 25px;" />          
                   <div class = "top-right3">
                    <h1>    Choclate Carmel Oreo Pie</h1>
                    <h2>Rs.  1200</h2>
                ...
                <br/> <br/>
                <div>
                   <asp:Image ID="Image4"  ImageUrl="https://arcadiancafe.com/wp-content/uploads/2021/05/SizzlingSkilletBrownie.jpg" height="320px" width="490px"  runat="server" style="margin-left: 66px; margin-bottom: 55px; margin-right: 66px; margin-top: 0px;" />
                     <div class = "top-right">
    ...
    <br/> <br/>
                ...
                <div style="height: 387px">
                    <asp:Image ID="Image2"  ImageUrl="https://arcadiancafe.com/wp-content/uploads/2021/05/StrawberryCheesecake.jpg" height="402px" width="501px"  runat="server" style="margin-left: 65px; margin-bottom: 0px; margin-right: 2px; margin-top: 0px;" />
                      <div class = "top-right1">
                    <h1>Sizzling Skillet Brownie </h1>
                    <h2 style="height: 34px; width: 374px">Rs.  800</h2>
    ...
    <br/> <br/>      
     ...
     <div>
         <asp:Image ID="Image3" ImageUrl="https://arcadiancafe.com/wp-content/uploads/2021/04/chocolatecarameloreopie-2.jpg" width = "463px" Height ="347px" runat="server" style="margin-right: 38px; margin-top: 63px; margin-left: 68px; margin-bottom: 3px;" />
